...
.sidebar-nav {
  ...
  li {
    ...
    color: #7aa2f7;//$sidebar-nav-color;
    cursor: pointer;
    ...
    &:hover {
      color: #f7768e;//$sidebar-nav-hover-color;
    }
  }
}

.sidebar-toc-active .sidebar-nav-toc, .sidebar-overview-active .sidebar-nav-overview {
  border-bottom-color: #7aa2f7;//$sidebar-highlight;
  color: #7aa2f7//$sidebar-highlight;

  &:hover {
    color: #f7768e;//$sidebar-highlight;
  }
}
